...
- **Base URL**: `http://<head-node-ip>:9202/v1`
...
client = OpenAI(
    base_url="http://172.26.92.232:9202/v1",
...
```bash
curl http://172.26.92.232:9202/v1/chat/completions \
...
- **Ray Serve HTTP**: Port 9202 (shared with kandinsky and medgemma endpoints)
- **Ray Dashboard**: Port 8265
- **OpenAI API**: `http://<head-node-ip>:9202/v1`
